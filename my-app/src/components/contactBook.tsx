...
import { toDateTime } from "@/shared/libs/dateTimeConverter";
            ...
            <div className="grid gap-2">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="p-2 cursor-pointer hover:bg-primary-light-shade rounded-full"
                >
              ...
              {contacts?.map((contact, index) => (
                <Contact
                  ...
                  className="p-2 cursor-pointer hover:bg-primary-light-shade rounded-lg text-left"
                >
                  <Type type="sm">last seen on {toDateTime(contact.lastSeen)}</Type>
                </Contact>
              ))}
            </div>
          </ContainerSmCenter>
